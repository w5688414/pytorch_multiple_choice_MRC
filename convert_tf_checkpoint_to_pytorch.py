...
if __name__ == "__main__":
    ...
    parser.add_argument("--tf_checkpoint_path",
                        default='check_points/prev_trained_model/albert_xxlarge_v2/model.ckpt-best',
                        type=str,
                        help="Path the TensorFlow checkpoint path.")
    parser.add_argument("--bert_config_file",
                        default='check_points/prev_trained_model/albert_xxlarge_v2/albert_config.json',
                        type=str,
                        help="The config json file corresponding to the pre-trained BERT model. \n"
                             "This specifies the model architecture.")
    parser.add_argument("--pytorch_dump_path",
                        default='check_points/prev_trained_model/albert_xxlarge_v2/pytorch_albert_model.pth',
                        type=str,
